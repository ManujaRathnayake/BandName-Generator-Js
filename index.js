...
app.get("/", (req, res) => {
  ...
  res.render("index.ejs" , { adj: null, noun: null, year: new Date().getFullYear() });
});
...
app.post("/submit", (req, res) => {
   ...
   function randompick(array) {
    ...
    const randomAdj = randompick(adj);
    const randomNoun = randompick(noun);
    const today = new Date();
    const currentYear = today.getFullYear();
    res.render("index", { adj: randomAdj, noun: randomNoun, year: currentYear });
